...
type user struct {
	...
	UserUID     field.String // 用户唯一ID
	Nickname    field.String // 昵称
	Avatar      field.String // 头像
	Email       field.String // 邮箱
	Provider    field.String // 主要登录提供商
	ProviderUID field.String // 第三方平台用户UID
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserUID = field.NewString(table, "user_uid")
	u.Nickname = field.NewString(table, "nickname")
	u.Avatar = field.NewString(table, "avatar")
	u.Email = field.NewString(table, "email")
	u.Provider = field.NewString(table, "provider")
	u.ProviderUID = field.NewString(table, "provider_uid")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["provider_uid"] = u.ProviderUID

...
1. Replace existing import paths that reference this template module.
2. Rename the command, service metadata, and sample API package to match your
  service.
3. Replace the sample CRUD resource with your own resource.
4. Regenerate code and verify the project:
